---
# End-to-End Data Platform: Olist Pipeline, BI Modeling, and Automation

This project implements a full data engineering lifecycle using the Olist e-commerce dataset. It moves data from raw ingestion to a structured Gold-layer star schema, culminating in a predictive model and an automated intervention service.
